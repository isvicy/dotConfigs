...
-- Telescope
utils.map('n', '<C-p>', "<cmd>lua require'telescope'.extensions.fzf_writer.files()<CR>")
utils.map('n', 'gr', "<cmd>lua require'telescope.builtin'.lsp_references()<CR>")
utils.map('n', '<Leader>gw', "<cmd>lua require'telescope'.extensions.fzf_writer.staged_grep()<CR>")
